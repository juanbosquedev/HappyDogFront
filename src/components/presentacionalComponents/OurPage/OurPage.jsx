...
export const OurPage = () => {
  return (
    <div>
      <div className={`${Style.aboutHeader} mt-5 mb-5`}>
        <p className="d-flex justify-content-center" style={{fontSize:"20px", fontWeight:"400", fontFamily:"sans-serif"}}>RECORRIDO</p>
        <hr style={{ borderColor: "rgb(129, 204, 176)", borderWidth: "2px" }} />
      </div>

      <div className="container-md " style={{ height: "55vh" }}>
        <div className="row">
          <a className="col-md-3 text-decoration-none"   href="#adopt">
            <Card
          ...
          <a className="col-md-3 text-decoration-none"   href="#home">
